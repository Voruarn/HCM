...
def get_argparser():
    ...
    parser.add_argument("--trainset_path", type=str, 
        default='../Datasets/AB2019BAS/Train',
        help="path to Dataset")
    parser.add_argument("--testset_path", type=str, 
        default='../Datasets/AB2019BAS/Test',
        help="path to Dataset")
    parser.add_argument("--dataset", type=str, default='Bushfire', help='Name of dataset')
...
def get_dataset(opts):
    ...
    train_dst = AB2019BASDataset(is_train=True,voc_dir=opts.trainset_path)
