...
def convnextv2_atto(num_classes=2):
...
def convnextv2_femto(num_classes=2):
...
def convnextv2_pico(num_classes=2):
...
def convnextv2_nano(num_classes=2):
...
def convnextv2_tiny(num_classes=2):
...
def convnextv2_small(num_classes=2):
    #https://dl.fbaipublicfiles.com/convnext/convnextv2/im1k/convnextv2_tiny_1k_224_ema.pt
    model = ConvNeXtV2(depths=[3, 3, 9, 3], dims=[128, 256, 512, 1024], num_classes=num_classes)
    return model

def convnextv2_base(num_classes=2):
...
def convnextv2_large(num_classes=2):
...
def convnextv2_huge(num_classes=2):
