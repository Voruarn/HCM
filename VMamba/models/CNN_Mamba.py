    ...
    def __init__(
        ...
        **kwargs,
        ...
        for i_layer in range(self.num_layers):
            ...
            self.dslayers.append(downsample)

            if i_layer<=1:
                stage = nn.Sequential(
                    *[Block(dim=self.dims[i_layer]) for j in range(depths[i_layer])]
                )
...
# =====================================================
def HCM_tiny_s2l5(channel_first=True):
    return VSSM(
...
# =====================================================
def HCM_tiny_s1l8(channel_first=True):
    return VSSM(
